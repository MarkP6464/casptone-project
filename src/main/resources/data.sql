...
INSERT INTO role (`id`,`role_name`) VALUES (3,'EXPERT');
INSERT INTO role (`id`,`role_name`) VALUES (4,'ADMIN');

--expert

INSERT INTO users (`name`,`account_balance`,`address`,`avatar`,`country`,`email`,`linkin`,`password`,`personal_website`,`phone`,`status`,`vip`,`role_id`,`about`,`company`,`job_title`,`publish`,`experience`,`history_id`,`number_review`,`price`,`punish`,`punish_date`)
